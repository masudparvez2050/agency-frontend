...
interface PageCMSTemplateProps {
  pageKey: keyof PageCopyConfig;
  title: string;
  description: string;
}

export default function PageCMSTemplate({ pageKey, title: cmsTitle, description }: PageCMSTemplateProps) {
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div>
        <h1 className="text-2xl font-black text-white">{cmsTitle}</h1>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <div className="p-6 rounded-2xl bg-slate-955/60 border border-slate-900 space-y-4 shadow-lg relative">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">Hero Subtitle Description</label>
