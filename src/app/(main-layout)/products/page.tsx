      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-7 items-start">
          ...
          <div className="lg:col-span-9 space-y-6">
            ...
            {/* Products Grid: 3 columns per row on desktop */}
                    ...
                    <div className="px-5 pb-5 pt-0 space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                          ...
                          className="py-2 px-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all shadow-md shadow-blue-500/20 cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap"
                        >
