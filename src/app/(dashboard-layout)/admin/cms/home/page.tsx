...
import { Save, Check, FileText, Layout } from "lucide-react";
...
export default function HomeCMS() {
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div>
        <h1 className="text-2xl font-black text-white">Home Page CMS</h1>
        <p className="text-xs text-slate-400 mt-1">Manage titles and description paragraphs for Home page sections.</p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="p-6 rounded-2xl bg-slate-955/60 border border-slate-900 space-y-4 shadow-lg relative">
          <h3 className="text-xs font-bold text-white flex items-center gap-2 border-b border-slate-900 pb-3">
            <FileText className="w-4 h-4 text-purple-400" /> Hero Section Content
          </h3>
          <div className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">Badge Tagline</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">Hero Subtitle Text</label>
        ...
        <div className="p-6 rounded-2xl bg-slate-955/60 border border-slate-900 space-y-4 shadow-lg relative">
          <h3 className="text-xs font-bold text-white flex items-center gap-2 border-b border-slate-900 pb-3">
            <Layout className="w-4 h-4 text-cyan-400" /> Bottom CTA Copy
          </h3>
          <div className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">CTA Headline Title</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">CTA Subtitle Description</label>
        ...
        <button type="submit" className="flex items-center gap-2 px-8 py-3 rounded-xl bg-purple-600 hover:bg-purple-500 text-xs font-bold text-white transition-all shadow-md">
          <Save className="w-4 h-4" /> Save Home CMS Content
        </button>
      </form>
    </div>
  );
